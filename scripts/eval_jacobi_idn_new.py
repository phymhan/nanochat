...
@torch.inference_mode()
def forward_fused(model, idx, seq_layers, pw, chunk_weights, K=1, elk_k=0.0, init_h=None, avg=False):
...
@torch.inference_mode()
def forward_fused_split(model, idx, seq_layers, pw, K=1, elk_k=0.0, init_h=None, avg=False,
                         init='h0', preheat_cache=None):
...
@torch.inference_mode()
def forward_chunkwise_batched(model, idx, seq_layers, pw, chunk_weights_list, K=1, elk_k=0.0, init_h=None, avg=False,
                               init='h0', preheat_cache=None):
